...
> **Business Central {Year} Wave {1|2} — {CU label}**
> Aligned with Business Central cumulative update **{BC Version}.{CU Number}**

---

## Overview

This release plan tracks proposed AL Copilot Skills for the **{Month} {Year}** contribution cycle.
...
2. **Add your skill entry** to the corresponding monthly `plan.md` file.
